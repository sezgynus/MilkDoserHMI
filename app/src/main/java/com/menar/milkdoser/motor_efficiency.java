...
public class motor_efficiency extends AppCompatActivity {
    ...
    public void initviews() {
        calibration_a = (Button) findViewById(R.id.a_calibration);
        calibration_b = (Button) findViewById(R.id.b_calibration);
        fill_a = (Button) findViewById(R.id.a_fill);
        fill_b = (Button) findViewById(R.id.b_fill);
        ...
        motor_a_eff = (SeekBar) findViewById(R.id.motorA);
        motor_a_per = (TextView) findViewById(R.id.motorA_per);
        motor_b_eff = (SeekBar) findViewById(R.id.motorB);
        motor_b_per = (TextView) findViewById(R.id.motorB_per);
        max_dose_a = (TextView) findViewById(R.id.max_dosing_a);
        max_dose_b = (TextView) findViewById(R.id.max_dosing_b);
        ml_input_a = (EditText)findViewById(R.id.ml_a);
        ml_input_b = (EditText)findViewById(R.id.ml_b);
        ...
        ml_input_a.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start,
                ...
                if(ml_input_a.getText().length()>0)
                {
                    ...
                    max_dose_a.setText(String.valueOf(utils.pulse_to_ml(65535,PPML_A,false))+"mL");
                }
            }
        });
        ml_input_b.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start,
                ...
                if (ml_input_b.getText().length() > 0) {
                    ...
                    max_dose_b.setText(String.valueOf(utils.pulse_to_ml(65535, PPML_B, false))+"mL");
                }
            }
        });
        calibration_a.setOnTouchListener(new View.OnTouchListener() {
        ...
        calibration_b.setOnTouchListener(new View.OnTouchListener() {
            public boolean onTouch(View view, MotionEvent event) {
                if (event.getAction() == android.view.MotionEvent.ACTION_DOWN) {
        ...
        fill_a.setOnTouchListener(new View.OnTouchListener() {
            public boolean onTouch(View view, MotionEvent event) {
                if (event.getAction() == android.view.MotionEvent.ACTION_DOWN) {
                    l_cmd = 2;
                } else if (event.getAction() == android.view.MotionEvent.ACTION_UP) {
        ...
        fill_b.setOnTouchListener(new View.OnTouchListener() {
            public boolean onTouch(View view, MotionEvent event) {
                if (event.getAction() == android.view.MotionEvent.ACTION_DOWN) {
                    r_cmd = 2;
                } else if (event.getAction() == android.view.MotionEvent.ACTION_UP) {
        ...
        motor_a_eff.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                motor_a_per.setText("%" + String.valueOf(map((PWM_A - minimum_pwm), 0, 323, 0, 100)));
            }
        });
        motor_b_eff.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                motor_b_per.setText("%" + String.valueOf(map((PWM_B - minimum_pwm), 0, 323, 0, 100)));
            }
        });
        ...
        public void run() {
            if(wifi_connected) {
                handler.post(new Runnable() {
                    @Override
                    public void run() {
                        new Thread(new motor_efficiency.querry(query_buf)).start();
                    }
                });
            }
            else {
