...
public class brightness_screen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        br= findViewById(R.id.seekBar);
        bri_per= findViewById(R.id.percentage);
        br.setProgress(Settings.System.getInt(getApplicationContext().getContentResolver(), Settings.System.SCREEN_BRIGHTNESS, 0));
        bri_per.setText("%"+ map(Settings.System.getInt(getApplicationContext().getContentResolver(), Settings.System.SCREEN_BRIGHTNESS, 0), 0, 255, 0, 100));
