...
public class TempPicker extends FrameLayout {
    

    private static final OnTempChangedListener NO_OP_CHANGE_LISTENER = new OnTempChangedListener() {
    ...
    public interface OnTempChangedListener {
        ...
        void onTempChanged(TempPicker view, int hourOfDay, int minute, int seconds);
    }
    ...
    public TempPicker(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TempPicker(Context context, AttributeSet attrs, int defStyle) {
     ...
     // digits of seconds
        ...
        mSecondPicker.setMaxValue(3);
        String[] values = {"00","25","50","75"};
        mSecondPicker.setDisplayedValues(values);
        ...
        setOnTempChangedListener(NO_OP_CHANGE_LISTENER);
     ...
     * @param onTempChangedListener the callback, should not be null.
     */
    public void setOnTempChangedListener(OnTempChangedListener onTempChangedListener) {
        mOnTempChangedListener = onTempChangedListener;
    }
    ...
    private void onTempChanged() {
        mOnTempChangedListener.onTempChanged(this, getCurrentHour(), getCurrentMinute(), getCurrentSeconds());
    }
